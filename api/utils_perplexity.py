...
- 【運命の地図】：全体のテーマ・運命の地図（400文字程度）
- 【過去】：生まれ持った資質・これまでの流れ（300文字程度）
- 【現在】：今の課題・テーマ（300文字程度）
- 【未来】：これから開いていく可能性（300文字程度）
- 【エレメント診断】：火・地・風・水のバランスと不足要素（300文字程度）
- 【オラクルカードのメッセージ】：カードの正逆を踏まえたメッセージ（300文字程度）
- 【石の提案】：どんな意図で石を選んだか、どんな願いをサポートするか（400文字程度）
"""
...
{{
  "destiny_map": "【運命の地図】全体のテーマ・運命の地図を400文字程度で。ユーザーの人生の全体像や現在のフェーズを深く読み解いてください",
  "past": "【過去】生まれ持った資質・これまでの流れを300文字程度で。詳しく丁寧に説明してください",
  "present": "【現在】今の課題・テーマを300文字程度で。詳しく丁寧に説明してください",
  "future": "【未来】これから開いていく可能性を300文字程度で。希望的なメッセージを含めてください",
  "element_diagnosis": "【エレメント診断】火・地・風・水のバランスと不足要素、アドバイスを300文字程度で。どうバランスを取るべきかを示唆してください",
  "oracle_message": "【オラクルカードのメッセージ】引いたカード「{oracle_result['card']['name']}」の{position_str}の詳細メッセージを300文字程度で。ユーザーの状況にどう当てはまるかを説明してください",
  "bracelet_proposal": "【石の提案】どんな意図で石を選び、どんな願いをサポートするか、400文字程度で。石の組み合わせの意味や相乗効果を丁寧に説明してください",
  "stones_for_user": [
    {{
      "name": "石の名前",
