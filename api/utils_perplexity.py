...
- destiny_map: 全体のテーマ・運命の地図（200文字程度）。見出し【】は不要、本文のみ。
- past: 生まれ持った資質・これまでの流れ（150文字程度）。見出し【】は不要、本文のみ。
- present: 今の課題・テーマ（150文字程度）。見出し【】は不要、本文のみ。
- future: これから開いていく可能性（150文字程度）。見出し【】は不要、本文のみ。
- element_diagnosis: 火・地・風・水のバランスと不足要素（150文字程度）。見出し【】は不要、本文のみ。
- oracle_message: カードの正逆を踏まえたメッセージ（150文字程度）。見出し【】は不要、本文のみ。
- bracelet_proposal: どんな意図で石を選んだか、どんな願いをサポートするか（150文字程度）。見出し【】は不要、本文のみ。
